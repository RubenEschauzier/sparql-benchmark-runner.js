import type { IMetricInput } from 'optimal-traversal-metric';
import { RunLinkTraversalPerformanceMetrics } from 'optimal-traversal-metric';
...
export class CalculateOptimalTraversalMetric {
  ...
  public prepareMetricInput(
    ...
    for (const [ k, nodeMetaDatum ] of nodeMetaData.entries()) {
      if (!nodeMetaDatum.hasParent) {
